...
pub use profile::{
    ...
    DESCRIPTION_MAX_BYTES, DISPLAY_NAME_MAX_BYTES, INSTRUCTIONS_MAX_BYTES, MAX_SKILL_REFS,
    MAX_SPECIALTY_TAGS, McpRef, PERSONALITY_MAX_BYTES, PRIMARY_SPECIALTY_MAX_BYTES,
