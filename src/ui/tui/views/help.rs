...
fn content(theme: &Theme) -> Vec<Line<'static>> {
    vec![
        ...
        Line::raw("Agents detail       A/D selects Profile / Memory / Skills / History"),
        Line::raw("                    Enter opens the selected nested workspace"),
        Line::raw("N / E / H           New or Resume draft / Edit / History when shown"),
        ...
        Line::raw("Memory and Skills retain their existing guided controls and exact reviews."),
        Line::raw("Follow their contextual hints for Esc, input, and confirmation."),
    ]
}
